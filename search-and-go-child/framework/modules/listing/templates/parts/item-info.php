<?php
/* mods
* 24jun16 zig -  hide website name use  "Visit website."
* 	  		  - hide open hours
*/
	...
	<div class="eltd-listing-item-open-hours">
		...
		if ( isset( $post_type_id ) && $post_type_id !== '' ) {
			...
			<?php if ( $show_website == 'yes' && $listing_website !== '' ) { ?>
				<a class="eltd-btn eltd-btn-medium eltd-btn-outline" href="<?php echo esc_attr( $listing_website ) ?>" class="eltd-listing-website" target="_blank" itemprop="url">
					<?php /* zig out echo esc_attr( $listing_website ); */?> Visit Website
				</a>
			<?php } ?>
