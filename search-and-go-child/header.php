<!DOCTYPE html>
<?php /* mods:  
        8Aug16 zig - add script for broadstreet ads.
...
<head>
    ...
    <script data-cfasync="false" type="text/javascript" src="https://street-production.s3.amazonaws.com/init.js"></script> <?php /* zig 8aug16 */ ?>
</head>

<body <?php body_class();?> itemscope itemtype="http://schema.org/WebPage">
<?php if ( function_exists( 'gtm4wp_the_gtm_tag' ) ) { gtm4wp_the_gtm_tag(); } /* zig 8Aug16 */?>
<?php 
