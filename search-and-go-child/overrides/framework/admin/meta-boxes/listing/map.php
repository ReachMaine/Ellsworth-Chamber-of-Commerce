...
if(!function_exists('search_and_go_elated_map_listing_settings')) {
    function search_and_go_elated_map_listing_settings() {
		...
		$meta_box_listing = search_and_go_elated_create_meta_box(array(
            'scope' => 'listing-item',
            'title'  =>  esc_html__( 'Listing Settings', 'search-and-go' ),
		...
		search_and_go_elated_create_meta_box_field(
			array(
				...
				'default_value' => '',
				'label'  =>  esc_html__( 'Listing Subtitle', 'search-and-go' ),
				'description' => ''
			)
		);
		...
		search_and_go_elated_create_meta_box_field(
			array(
				...
				'default_value' => 'Basic',
				'options' => array(104=>'Basic', 106=>'Premium'),
				'label'  =>  esc_html__( 'Listing Package.', 'search-and-go' ),
				'description' => ''
			)
		);
...
/*	    search_and_go_elated_create_meta_box_field(
	    ...
	    search_and_go_elated_create_meta_box_field(array(
		    ...
		    'type'        => 'address',
		    'label'       => 'Address',
		    'description' => esc_html__( 'Find address', 'search-and-go' )
	    ));

	    search_and_go_elated_create_meta_box_field(array(
            'name'        => 'eltd_listing_feature_item',
            'type'        => 'select',
            'label'        =>  esc_html__( 'Set as Featured Item', 'search-and-go' ),
			'default_value' => 'no',
			'options'		 => array(
				'no'=> 'No',
				'yes'=> 'Yes'
			),
            'description' => esc_html__( 'Set listing item as featured listing feature list shortcode', 'search-and-go' ),
            'parent'      => $meta_box_listing
        ));
		search_and_go_elated_create_meta_box_field(
			array(
		...
		if (is_array($listing_types) && count($listing_types)) {
			...
			search_and_go_elated_create_meta_box_field(array(
				...
				'type'        => 'select',
				'label'        =>  esc_html__( 'Listing Type', 'search-and-go' ),
				'description' => esc_html__( 'Choose a default type for Single Listing pages', 'search-and-go' ),
			...
			$gallery_container = search_and_go_elated_add_admin_container_no_style(
				...
				search_and_go_elated_add_multiple_images_field(
					array(
						...
						'description' => esc_html__( 'Choose your gallery images', 'search-and-go' )
					)
				);
			...
			$video_container = search_and_go_elated_add_admin_container_no_style(
				...
				search_and_go_elated_create_meta_box_field(
					array(
						...
						'description' => esc_html__( 'Enter Youtube ot Vimeo URL address', 'search-and-go' )
					)
				);
			...
			$audio_container = search_and_go_elated_add_admin_container_no_style(
				...
				search_and_go_elated_create_meta_box_field(
					...
					array(
						...
						'description' => esc_html__( 'Enter Audio File', 'search-and-go' )
					)
				);
			...
			$price_container = search_and_go_elated_add_admin_container_no_style(
				...
				search_and_go_elated_create_meta_box_field(
					...
					array(
						...
						'default_value' => '',
						'label' => 'Price',
						'description' => esc_html__( 'Enter Price', 'search-and-go' )
					)
				);
			...
			$sidebar_gallery_container = search_and_go_elated_add_admin_container_no_style(
				...
				search_and_go_elated_add_multiple_images_field(
					array(
						...
						'description' => esc_html__( 'Choose your sidebar gallery images', 'search-and-go' )
					)
				);
			...
			search_and_go_elated_create_meta_box_field(
				...
				array(
					...
					'default_value' => '',
					'label' => 'Open Table ID',
					'description' => esc_html__( 'Insert Open Table ID of place for booking', 'search-and-go' )
				)
			);
