<?php /* mods 
* 23Sept16 zig - x-out comment "No comments" & "comments closed" for everything except listings.
*/ ?>
		...
		<div class="eltd-comment-number-inner">
			<h5><?php
				if ( is_singular('listing-item')) {
					...
					/* zig xout comments_number( esc_html__('No Comments','search-and-go'), '1'.esc_html__(' Comment ','search-and-go'), '% '.esc_html__(' Comments ','search-and-go')); */
				}
				?>
			</h5>
		</div>
...
<?php if ( have_comments() ) : ?>
	...
	<ul class="eltd-comment-list">
		...
		if ( is_singular('listing-item')) {
			...
			/* zig xout wp_list_comments(array( 'callback' => 'search_and_go_elated_comment')); */
		}
		?>
	</ul>
...
?>
		...
		<?php /* <p><?php esc_html_e('Sorry, the comment form is closed at this time.', 'search-and-go'); ?></p> */ ?>
